  ...
  return (
    <>
      ...
      <main className="main__content_wrapper">
        ...
        <section className="breadcrumb__section breadcrumb__bg breadcrumb__bg--news">
                  ...
                  <div className="blog__items">
                    ...
                    <div className="blog__content">
                      ...
                      <h3 className="blog__content--title h4">
                        <Link href={`/news-details/${post.id}`}>{post.title}</Link>
                      </h3>
