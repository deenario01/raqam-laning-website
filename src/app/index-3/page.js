  ...
  return (
    <>
      ...
      <header className="header__section header__section3 header__transparent mb-20 color-scheme-3">
            ...
            <div className="header__topbar--inner header__topbar--inner2 d-flex align-items-center justify-content-between">
              <ul className="header__info d-flex align-items-center">
                <li className="header__info--list">
                  ...
                  <Link className="header__info--text" href="tel:+001-234-567-890">
                    +001-234-567-890{" "}
                  </Link>
                </li>
                <li className="header__info--list">
                  ...
                  >
                    <g id="email" transform="translate(0 -85.333)">
                      ...
                      <g
                        id="Group_267"
                        data-name="Group 267"
                        transform="translate(2.143 87.476)"
                      >
                      ...
                      <g
                        id="Group_269"
                        data-name="Group 269"
                        transform="translate(2.142 93.904)"
                      >
                        <g id="Group_268" data-name="Group 268">
                          <path
                            ...
                            transform="translate(-42.646 -255.996)"
                            fill="#121a25"
                          />
                        </g>
                      </g>
                      <g
                        id="Group_271"
                        data-name="Group 271"
                        transform="translate(16.07 93.903)"
                      >
              ...
              <div className="header__shipping">
                <p className="header__shipping--text">
                  Get Up To 80% off In your first Offer!
                </p>
              </div>
              <div className="language__currency style2 d-none d-lg-block">
                <ul className="d-flex align-items-center">
                  <li className="language__currency--list">
                    <Link className="account__currency--link style2" href="#">
                  ...
                  <li className="language__currency--list">
                    <Link className="language__switcher style2" href="#">
                      <img
                ...
                <h1 className="main__logo--title">
                  <Link className="main__logo--link" href="/">
                    <img
                      ...
                      src="assets/img/logo/nav-log3.webp"
                      alt="logo-img"
                    />
                  </Link>
                </h1>
                ...
                <nav className="header__menu--navigation style3">
                  <ul className="d-flex justify-content-center">
                    <li className="header__menu--items style3">
                      <Link
                        className="header__menu--link style3"
                        href="/"
                      >
                    ...
                    <li className="header__menu--items mega__menu--items style3">
                      <Link className="header__menu--link style3" href="/shop">
                    ...
                    <li className="header__menu--items style3">
                      <Link className="header__menu--link style3" href="/news">
                    ...
                    <li className="header__menu--items style3">
                      <Link className="header__menu--link style3" href="#">
        ...
        <div className="offcanvas__header color-scheme-3" tabIndex={-1}>
        ...
        <div
          className="offcanvas__stikcy--toolbar color-scheme-3"
          tabIndex={-1}
        >
        ...
        <div className="offCanvas__minicart color-scheme-3" tabIndex={-1}>
        ...
        <div className="predictive__search--box color-scheme-3" tabIndex={-1}>
      ...
      <main className="main__content_wrapper">
        ...
        <section className="hero__slider--section color-scheme-3">
          <div className="container">
            <div className="row">
              <div className="col">
                <div className="hero__slider3--inner hero__slider--activation swiper">
                  <div className="hero__slider3--wrapper swiper-wrapper">
                    <div className="swiper-slide ">
                      <div className="hero__slider3--items hero__slider--bg3 slider1">
                        <div className="slider__content3 padding-left">
                          <h2 className="slider__content3--maintitle">
                            Make Beautiful Home <br />
                            With Moon Sofa
                          </h2>
                          <p className="slider__content3--desc mb-35">
                            Great furniture can bring beauty at your home,{" "}
                            <br />
                            So buy our popular and stylish furniture.{" "}
                          </p>
                          <Link
                            className="slider__content3--btn primary__btn btn__style3"
                            href="/shop"
                            rel="nofollow"
                          >
                            Order Now
                    ...
                    <div className="swiper-slide ">
                      <div className="hero__slider3--items hero__slider--bg3 slider2">
                        <div className="slider__content3 padding-left text-center">
                          <h2 className="slider__content3--maintitle">
                            Make Beautiful Home <br />
                            With Moon Sofa
                          </h2>
                          <p className="slider__content3--desc color-black mb-35">
                            Great furniture can bring beauty at your home,{" "}
                            <br />
                            So buy our popular and stylish furniture.{" "}
                          </p>
                    ...
                    <div className="swiper-slide ">
                      <div className="hero__slider3--items hero__slider--bg3 slider3">
                        <div className="slider__content3 padding-left">
                          <h2 className="slider__content3--maintitle">
                            Make Beautiful Home <br />
                            With Moon Sofa
        ...
        <section className="categories__section color-scheme-3 section--padding">
          <div className="container">
            ...
            <div className="categories__section--inner">
              <div className="row row-cols-lg-6 row-cols-md-4 row-cols-sm-3 row-cols-2  mb--n30">
                <div className="col mb-30">
                  <div className="categories__product--items border border-radius-5 text-center">
                    <Link
                      className="categories__product--items__link"
                      href="/shop"
                    >
                      <img
                        className="categories__product--thumbnail__img display-block"
                        src="assets/img/product/categories-product1.webp"
                        alt="categories-product"
                      />
                      <h3 className="categories__product--title h4">Chairs</h3>
                    </Link>
                  </div>
                </div>
                <div className="col mb-30">
                  <div className="categories__product--items border border-radius-5 text-center">
                    ...
                    >
                      <img
                        className="categories__product--thumbnail__img display-block"
                        src="assets/img/product/categories-product2.webp"
                        alt="categories-product"
                      />
                      <h3 className="categories__product--title h4">
                        Bedstead
                      </h3>
                    </Link>
                  </div>
                ...
                <div className="col mb-30">
                  <div className="categories__product--items border border-radius-5 text-center">
                    ...
                    >
                      <img
                        className="categories__product--thumbnail__img display-block"
                        src="assets/img/product/categories-product3.webp"
                        alt="categories-product"
                      />
                      <h3 className="categories__product--title h4">Sofa</h3>
                    </Link>
                  </div>
                </div>
                <div className="col mb-30">
                  <div className="categories__product--items border border-radius-5 text-center">
                    ...
                    >
                      <img
                        className="categories__product--thumbnail__img display-block"
                        src="assets/img/product/categories-product4.webp"
                        alt="categories-product"
                      />
                      <h3 className="categories__product--title h4">
                        Tv Cabinet
                ...
                <div className="col mb-30">
                  <div className="categories__product--items border border-radius-5 text-center">
                    ...
                    >
                      <img
                        className="categories__product--thumbnail__img display-block"
                        src="assets/img/product/categories-product5.webp"
                        alt="categories-product"
                      />
                      <h3 className="categories__product--title h4">
                        Smart Fit
                ...
                <div className="col mb-30">
                  <div className="categories__product--items border border-radius-5 text-center">
                    ...
                    >
                      <img
                        className="categories__product--thumbnail__img display-block"
                        src="assets/img/product/categories-product6.webp"
                        alt="categories-product"
                      />
                      <h3 className="categories__product--title h4">Table</h3>
                    </Link>
                  </div>
                </div>
                <div className="col mb-30">
                  <div className="categories__product--items border border-radius-5 text-center">
                    ...
                    >
                      <img
                        className="categories__product--thumbnail__img display-block"
                        src="assets/img/product/categories-product7.webp"
                        alt="categories-product"
                      />
                      <h3 className="categories__product--title h4">
                        Wardrobe
                ...
                <div className="col mb-30">
                  <div className="categories__product--items border border-radius-5 text-center">
                    ...
                    >
                      <img
                        className="categories__product--thumbnail__img display-block"
                        src="assets/img/product/categories-product8.webp"
                        alt="categories-product"
                      />
                      <h3 className="categories__product--title h4">
                        Office Chair
                ...
                <div className="col mb-30">
                  <div className="categories__product--items border border-radius-5 text-center">
                    ...
                    >
                      <img
                        className="categories__product--thumbnail__img display-block"
                        src="assets/img/product/categories-product9.webp"
                        alt="categories-product"
                      />
                      <h3 className="categories__product--title h4">
                        Dressing Table
                ...
                <div className="col mb-30">
                  <div className="categories__product--items border border-radius-5 text-center">
                    ...
                    >
                      <img
                        className="categories__product--thumbnail__img display-block"
                        src="assets/img/product/categories-product10.webp"
                        alt="categories-product"
                      />
                      <h3 className="categories__product--title h4">
                        Miscellaneous
                ...
                <div className="col mb-30">
                  <div className="categories__product--items border border-radius-5 text-center">
                    ...
                    >
                      <img
                        className="categories__product--thumbnail__img display-block"
                        src="assets/img/product/categories-product11.webp"
                        alt="categories-product"
                      />
                      <h3 className="categories__product--title h4">Kitchen</h3>
                    </Link>
                  </div>
                </div>
                <div className="col mb-30">
                  <div className="categories__product--items border border-radius-5 text-center">
                    ...
                    >
                      <img
                        className="categories__product--thumbnail__img display-block"
                        src="assets/img/product/categories-product12.webp"
                        alt="categories-product"
                      />
                      <h3 className="categories__product--title h4">Door</h3>
                    </Link>
                  </div>
                </div>
              </div>
        ...
        <section className="product__section section--padding color-scheme-3 pt-0">
          <div className="container">
            <div className="section__heading text-center mb-40">
              <h2 className="section__heading--maintitle">Top New Furniture</h2>
            </div>
                  ...
                  <div className="product__items ">
                    <div className="product__items--thumbnail">
                      ...
                      <div className="product__badge style3">
                        <span className="product__badge--items style3 sale">
                          New
                        </span>
                      </div>
                    ...
                    <div className="product__items--content text-center">
                      ...
                      <Link
                        className="product__items--action__cart--btn primary__btn btn__style3"
                        href="/cart"
                      >
                        <svg
          ...
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-7 col-md-7">
                <div className="choiceus__banner position__relative d-flex">
                  <Link
                    className="choiceus__banner--thumbnail one display-block"
                    href="/shop"
                    rel="nofollow"
                  >
                    <img
                      className="choiceus__banner--thumbnail__img display-block"
                      src="assets/img/banner/banner23.webp"
                      alt="banner-img"
                    />
                  </Link>
                  <Link
                    className="choiceus__banner--thumbnail two display-block"
                    href="/shop"
                    rel="nofollow"
                  >
                    <img
                      className="choiceus__banner--thumbnail__img two display-block"
                      src="assets/img/banner/banner24.webp"
                      alt="banner-img"
                    />
                  </Link>
                  <div className="bideo__play style3">
                    <Link
                      className="bideo__play--icon style3 glightbox"
              ...
              <div className="col-lg-5 col-md-5">
                <div className="choiceus__content">
                  <h2 className="choiceus__content--title">
                    Why You Choice Us
                  </h2>
                  <p className="choiceus__content--desc">
                    Get up to 80% off for this weak and get offer. Don't miss
                    this chance hit order button.
                  </p>
                  <div className="choiceus__info">
                    <div className="choiceus__info--step d-flex">
                      <div className="choiceus__info--list">
                        <svg
                          className="choiceus__info--icon"
                          data-name="Group 118"
                          xmlns="http://www.w3.org/2000/svg"
                          width="38.02"
                          height="41.512"
                        ...
                        <span className="choiceus__info--text">
                          24/7 Support
                        </span>
                      </div>
                      <div className="choiceus__info--list">
                ...
                <div className="col mb-30">
                  <div className="product__items ">
                    ...
                    <div className="product__items--content text-center">
                      ...
                      <h3 className="product__items--content__title h4">
                        <Link href="/product-details">Globe Electric Lamp</Link>
                      </h3>
                      <div className="product__items--price">
                ...
                <div className="col mb-30">
                  <div className="product__items ">
                    ...
                    <div className="product__items--content text-center">
                      ...
                      <h3 className="product__items--content__title h4">
                        <Link href="/product-details">Design Rooms Sofa</Link>
                      </h3>
                      <div className="product__items--price">
                        <span className="current__price">$155.00</span>
        ...
        <section className="banner__section color-scheme-3 section--padding pt-0">
          <div className="container">
                ...
                <div className="banner__items">
                  ...
                  >
                    <img
                      ...
                      src="assets/img/banner/banner20.webp"
                      alt="banner-img"
                    />
                    <div className="banner__content--style3">
                      <h2 className="banner__content--style3__title">
                        Blue Elegant <br />
                        Chair
                      </h2>
                      <span className="banner__content--style3__price">
                        $25.55
                      </span>
                      <span className="banner__content--style3__btn primary__btn style3">
                        Buy Now
                      </span>
                    </div>
                  </Link>
        ...
        <div className="deals__banner--section color-scheme-3 section--padding pt-0">
          <div className="container">
            <div className="deals__banner--thumbnail mt-0">
              <Link
                className="deals__banner--thumbnail__link display-block position__relative"
                href="/shop"
              >
                <img
                  className="deals__banner--thumbnail__img style2 display-block"
                  src="assets/img/banner/banner-bg5.webp"
                  alt="deals-thumbnail-img "
                />
                <div className="deals__content--style2">
                  <h3 className="deals__content--style2__subtitle">
                    Get Discount Up to 80%
                  </h3>
                  <h2 className="deals__content--style2__maintitle text__primary">
                    Best Deal For Weak
                  </h2>
                  <p className="deals__content--style2__desc d-md-none">
                    Get up to 80% off for this weak and get offer. <br />
                    Don't miss this chance hit order button.
                  </p>
                  <div
                    className="deals__banner--countdown d-flex"
                    data-countdown="Sep 30, 2022 00:00:00"
                  />
                  <span className="primary__btn btn__style3">Order Now</span>
                </div>
              </Link>
            </div>
          </div>
        ...
        {/* Start deals banner section */}
        {/* Start product section */}
        <section className="new__product--section position__relative color-scheme-3">
          <div className="container">
            <div className="new__product--section__inner d-flex align-items-center">
              <div className="new__product--content">
                <h2 className="new__product--content__title">
                  2022 New Furniture Chair
                </h2>
                <p className="new__product--content__desc">
                  lacinia an, tincidunt risus ac, consequat velit. mos sodales
                  suscipit tortor ditaemcos.
                </p>
                <div className="new__product--price">
                  <span className="new__product--price__badge">Start From</span>
                  <ul className="new__product--price__inner d-flex align-items-center">
                    <li className="new__product--price__list">
                      <span className="new__product--current__price">
                        $25.00
                      </span>
                    </li>
                    <li className="new__product--price__list">
                      <span className="new__product--old__price">$30.00</span>
                    </li>
                  </ul>
                </div>
                <Link
                  className="new__product--content__btn primary__btn btn__style3"
                  href="/shop"
                >
                  View More
                </Link>
              </div>
              <div className="new__product--sidebar product__list--column3 swiper">
                <div className="swiper-wrapper">
                  <div className="swiper-slide">
                    <div className="product__items new__product--items border">
                      <div className="product__items--thumbnail">
                        <Link
                          className="product__items--link"
                          href="/product-details"
                        >
                          <img
                            className="product__items--img product__primary--img"
                            src="assets/img/product/product16.webp"
                            alt="product-img"
                          />
                        </Link>
                      </div>
                    ...
                    <div className="product__items new__product--items border">
                      <div className="product__items--thumbnail">
                        ...
                        >
                          <img
                            className="product__items--img product__primary--img"
                            src="assets/img/product/product17.webp"
                            alt="product-img"
                          />
                        </Link>
                      </div>
                    ...
                    <div className="product__items new__product--items border">
                      <div className="product__items--thumbnail">
                        ...
                        >
                          <img
                            className="product__items--img product__primary--img"
                            src="assets/img/product/product18.webp"
                            alt="product-img"
                          />
                        </Link>
                      </div>
                ...
                <div className="product__pagination swiper-pagination" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="newsletter__banner--section section--padding color-scheme-3">
          <div className="container">
            <div className="newsletter__banner--thumbnail position__relative">
              <img
                className="newsletter__banner--thumbnail__img"
                src="assets/img/banner/banner-bg6.webp"
              ...
              <div className="newsletter__content newsletter__subscribe">
                ...
                >
                  ...
                  <button
                    className="newsletter__subscribe--button primary__btn btn__style3"
                    type="submit"
                  >
                    Subscribe
                    <svg
        ...
        <section className="testimonial__section section--padding color-scheme-2 pt-0">
          <div className="container">
            <div className="row">
              <div className="col">
                <div className="testimonial__section--inner">
                  ...
                  <div className=" testimonial__swiper--column4 testimonial__padding3 swiper">
                    <div className="swiper-wrapper">
                      <div className="swiper-slide">
                        <div className="testimonial__items--style3 border-radius-5">
                          <div className="testimonial__style3--topbar text-center">
                            ...
                            <div className="testimonial__style3--author">
                              ...
                              <h4 className="testimonial__style3--author__subtitle h5">
                                Product Designer
                              </h4>
                            </div>
                          </div>
                          <div className="testimonial__style3--content">
                            ...
                            <p className="testimonial__style3--content__desc text-center">
                              All children, except one grow upsoon know that
                              they up, and the way Wendy knew{" "}
                            </p>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="testimonial__items--style3 border-radius-5">
                          <div className="testimonial__style3--topbar text-center">
                            <div className="testimonial__thumbnail--style3">
                              <img
                                className="testimonial__thumbnail--style3__img display-block"
                                src="assets/img/other/testimonial-thumb6.webp"
                                alt="testimonial-img"
                              />
                            </div>
                            <div className="testimonial__style3--author">
                        ...
                        <div className="testimonial__items--style3 border-radius-5">
                          <div className="testimonial__style3--topbar text-center">
                            <div className="testimonial__thumbnail--style3">
                              <img
                                className="testimonial__thumbnail--style3__img display-block"
                                src="assets/img/other/testimonial-thumb7.webp"
                                alt="testimonial-img"
                              />
                            </div>
                            <div className="testimonial__style3--author">
        ...
        {/* Start blog section */}
        <section className="blog__section section--padding color-scheme-3 pt-0">
          <div className="container">
            <div className="section__heading text-center mb-30">
              <h2 className="section__heading--maintitle">
            ...
            <div className="blog__section--inner blog__swiper--column3 swiper">
              <div className="swiper-wrapper">
                <div className="swiper-slide">
                  <div className="blog__items">
                    ...
                    <div className="blog__content text-center">
                      <ul className="blog__content--meta d-flex justify-content-center">
                      ...
                      <Link
                        className="blog__content--btn primary__btn btn__style3"
                        href="/news-details"
                      >
                        Read more{" "}
                      </Link>
        ...
        <div className="instagram__section section--padding color-scheme-3 pt-0">
                ...
                <div className="swiper-slide">
                  <div className="instagram__thumbnail position__relative">
                    ...
                    >
                      <img
                        className="instagram__thumbnail--img display-block"
                        src="assets/img/other/instagram7.webp"
                        alt="instagram-img"
                      />
                      <span className="instagram__social--icon">
                        <svg
      ...
      <footer className="footer__section footer__bg color-scheme-3">
        <div className="container">
            ...
            <div className="row">
              ...
              <div className="col-lg-3 col-md-6">
                <div className="footer__widget">
                  ...
                  <div className="footer__contact--info footer__widget--inner">
                    <ul className="footer__contact--info__inner">
                      <li className="footer__contact--info__text">
                        <strong>Address:</strong> 1351 New Jercy Rd, USA 48247
                      </li>
                      <li className="footer__contact--info__text">
                        <strong>Email:</strong>{" "}
                      ...
                      <li className="footer__contact--info__text">
                        <strong>Phone:</strong>{" "}
                        <Link href="tel:+001-234-567-890">+001-234-567-890 </Link>
                      </li>
                    </ul>
                    <div className="footer__payment--method">
                      <h3 className="footer__payment--method__title">
      ...
      {/* Quickview Wrapper */}
      <div
        className="modal color-scheme-3"
        id="modal1"
