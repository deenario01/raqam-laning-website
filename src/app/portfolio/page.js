  ...
  <header className="header__section header__others border-bottom header__transparent mb-30">
      ...
      <div className="container">
        <div className="main__header--inner position__relative d-flex justify-content-between align-items-center">
          ...
          <div className="main__logo">
            <Link className="main__logo--link" href="index.html">
              <img
            ...
            <nav className="header__menu--navigation">
              <ul className="d-flex">
                <li className="header__menu--items style3">
                  <Link className="header__menu--link" href="index.html">
                    Home <span className="menu__plus--icon">+</span>
                  </Link>
                  <ul className="header__sub--menu">
                    <li className="header__sub--menu__items">
                      <Link href="index.html" className="header__sub--menu__link">
                        Home One
                      </Link>
                    </li>
                    <li className="header__sub--menu__items">
                ...
                <li className="header__menu--items style3">
                  <Link className="header__menu--link" href="about.html">
                    About US{" "}
                  </Link>
                </li>
                <li className="header__menu--items style3">
                  <Link className="header__menu--link" href="blog.html">
                    Blog <span className="menu__plus--icon">+</span>{" "}
                  </Link>
                  <ul className="header__sub--menu">
                    <li className="header__sub--menu__items">
                      <Link href="blog.html" className="header__sub--menu__link">
                        Blog Grid
                      </Link>
                    </li>
                    <li className="header__sub--menu__items">
                ...
                <li className="header__menu--items style3">
                  ...
                  <ul className="header__sub--menu">
                    <li className="header__sub--menu__items">
                      <Link href="about.html" className="header__sub--menu__link">
                        About Us
                      </Link>
                    </li>
                    <li className="header__sub--menu__items">
                    ...
                    <li className="header__sub--menu__items">
                      <Link href="cart.html" className="header__sub--menu__link">
                        Cart Page
                      </Link>
                    </li>
                    <li className="header__sub--menu__items">
                    ...
                    <li className="header__sub--menu__items">
                      <Link href="login.html" className="header__sub--menu__link">
                        Login Page
                      </Link>
                    </li>
                    <li className="header__sub--menu__items">
                      <Link href="404.html" className="header__sub--menu__link">
                        Error Page
                      </Link>
                    </li>
                  </ul>
                ...
                <li className="header__menu--items style3">
                  <Link className="header__menu--link" href="contact.html">
                    Contact{" "}
                  </Link>
                </li>
              </ul>
          ...
          <div className="header__account">
            <ul className="d-flex">
              ...
              <li className="header__account--items">
                <Link className="header__account--btn" href="my-account.html">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="26.51"
                    height="23.443"
              ...
              <li className="header__account--items d-sm-none">
                <Link className="header__account--btn" href="wishlist.html">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24.526"
                    height="21.82"
        ...
        <nav className="offcanvas__menu">
          <ul className="offcanvas__menu_ul">
            <li className="offcanvas__menu_li">
              ...
              <ul className="offcanvas__sub_menu">
                <li className="offcanvas__sub_menu_li">
                  <Link href="index.html" className="offcanvas__sub_menu_item">
                    Home One
                  </Link>
                </li>
                <li className="offcanvas__sub_menu_li">
                  <Link href="index-2.html" className="offcanvas__sub_menu_item">
                    Home Two
                  </Link>
                </li>
                <li className="offcanvas__sub_menu_li">
                  <Link href="index-3.html" className="offcanvas__sub_menu_item">
                    Home Three
                  </Link>
                </li>
              </ul>
            ...
            <li className="offcanvas__menu_li">
              ...
              <ul className="offcanvas__sub_menu">
                <li className="offcanvas__sub_menu_li">
                  ...
                  <ul className="offcanvas__sub_menu">
                    <li className="offcanvas__sub_menu_li">
                      <Link className="offcanvas__sub_menu_item" href="shop.html">
                        Shop Left Sidebar
                      </Link>
                    </li>
                    <li className="offcanvas__sub_menu_li">
                ...
                <li className="offcanvas__sub_menu_li">
                  ...
                  <ul className="offcanvas__sub_menu">
                    ...
                    <li className="offcanvas__sub_menu_li">
                      <Link className="offcanvas__sub_menu_item" href="404.html">
                        404 Page
                      </Link>
                    </li>
                    <li className="offcanvas__sub_menu_li">
                      <Link className="offcanvas__sub_menu_item" href="login.html">
                        Login Page
                      </Link>
                    </li>
                    <li className="offcanvas__sub_menu_li">
                      <Link className="offcanvas__sub_menu_item" href="faq.html">
                        Faq Page
                      </Link>
                    </li>
                  </ul>
                ...
                <li className="offcanvas__sub_menu_li">
                  ...
                  <ul className="offcanvas__sub_menu">
                    ...
                    <li className="offcanvas__sub_menu_li">
                      <Link className="offcanvas__sub_menu_item" href="cart.html">
                        Cart Page
                      </Link>
                    </li>
                    <li className="offcanvas__sub_menu_li">
            ...
            <li className="offcanvas__menu_li">
              ...
              <ul className="offcanvas__sub_menu">
                <li className="offcanvas__sub_menu_li">
                  <Link href="about.html" className="offcanvas__sub_menu_item">
                    About Us
                  </Link>
                </li>
                <li className="offcanvas__sub_menu_li">
                  <Link href="contact.html" className="offcanvas__sub_menu_item">
                    Contact Us
                  </Link>
                </li>
                <li className="offcanvas__sub_menu_li">
                ...
                <li className="offcanvas__sub_menu_li">
                  <Link href="wishlist.html" className="offcanvas__sub_menu_item">
                    Wishlist Page
                  </Link>
                </li>
                <li className="offcanvas__sub_menu_li">
                  <Link href="login.html" className="offcanvas__sub_menu_item">
                    Login Page
                  </Link>
                </li>
                <li className="offcanvas__sub_menu_li">
    ...
    <div className="offcanvas__stikcy--toolbar" tabIndex={-1}>
      <ul className="d-flex justify-content-between">
        ...
        <li className="offcanvas__stikcy--toolbar__list">
          <Link className="offcanvas__stikcy--toolbar__btn" href="wishlist.html">
            <span className="offcanvas__stikcy--toolbar__icon">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18.541"
    ...
    <div className="offCanvas__minicart" tabIndex={-1}>
      ...
      <div className="minicart__product">
        <div className="minicart__product--items d-flex">
          <div className="minicart__thumbnail">
            <Link href="product-details.html">
              <img src="assets/img/product/product1.webp" alt="prduct-img" />
            </Link>
          </div>
          <div className="minicart__text">
            <h4 className="minicart__subtitle">
              <Link href="product-details.html">The is Garden Vegetable.</Link>
            </h4>
        ...
        <div className="minicart__product--items d-flex">
          <div className="minicart__thumbnail">
            <Link href="product-details.html">
              <img src="assets/img/product/product2.webp" alt="prduct-img" />
            </Link>
          </div>
          <div className="minicart__text">
            <h4 className="minicart__subtitle">
              <Link href="product-details.html">Fresh Tomatoe is organic.</Link>
            </h4>
            <span className="color__variant">
              <b>Color:</b> Green
            </span>
      ...
      <div className="minicart__conditions text-center">
        ...
        <label className="minicart__conditions--label" htmlFor="accept">
          I agree with the{" "}
          <Link className="minicart__conditions--link" href="privacy-policy.html">
            Privacy And Policy
          </Link>
        </label>
      </div>
      <div className="minicart__button d-flex justify-content-center">
        <Link className="primary__btn minicart__button--link" href="cart.html">
          View cart
        </Link>
        <Link className="primary__btn minicart__button--link" href="checkout.html">
          Checkout
        </Link>
      </div>
    </div>
            ...
            <div className="col mb-30">
              <div className="portfolio__items">
                <div className="portfolio__items--thumbnail position__relative">
                  <Link
                    className="portfolio__items--thumbnail__link glightbox"
                    href="assets/img/other/portfolio1.webp"
                    data-gallery="portfolio"
                  >
                    <img
                      className="portfolio__items--thumbnail__img"
                      src="assets/img/other/portfolio1.webp"
                      alt="portfolio-img"
                    />
            ...
            <div className="col mb-30">
              <div className="portfolio__items">
                <div className="portfolio__items--thumbnail position__relative">
                  <Link
                    className="portfolio__items--thumbnail__link glightbox"
                    href="assets/img/other/portfolio2.webp"
                    data-gallery="portfolio"
                  >
                    <img
                      className="portfolio__items--thumbnail__img"
                      src="assets/img/other/portfolio2.webp"
                      alt="portfolio-img"
                    />
                    <span className="portfolio__view--icon">
                      <svg
            ...
            <div className="col mb-30">
              <div className="portfolio__items">
                <div className="portfolio__items--thumbnail position__relative">
                  <Link
                    className="portfolio__items--thumbnail__link glightbox"
                    href="assets/img/other/portfolio3.webp"
                    data-gallery="portfolio"
                  >
                    <img
                      className="portfolio__items--thumbnail__img"
                      src="assets/img/other/portfolio3.webp"
                      alt="portfolio-img"
                    />
                    <span className="portfolio__view--icon">
                      <svg
            ...
            <div className="col mb-30">
              <div className="portfolio__items">
                <div className="portfolio__items--thumbnail position__relative">
                  <Link
                    className="portfolio__items--thumbnail__link glightbox"
                    href="assets/img/other/portfolio4.webp"
                    data-gallery="portfolio"
                  >
                    <img
                      className="portfolio__items--thumbnail__img"
                      src="assets/img/other/portfolio4.webp"
                      alt="portfolio-img"
                    />
                    <span className="portfolio__view--icon">
                      <svg
            ...
            <div className="col mb-30">
              <div className="portfolio__items">
                <div className="portfolio__items--thumbnail position__relative">
                  <Link
                    className="portfolio__items--thumbnail__link glightbox"
                    href="assets/img/other/portfolio5.webp"
                    data-gallery="portfolio"
                  >
                    <img
                      className="portfolio__items--thumbnail__img"
                      src="assets/img/other/portfolio5.webp"
                      alt="portfolio-img"
                    />
                    <span className="portfolio__view--icon">
                      <svg
            ...
            <div className="col mb-30">
              <div className="portfolio__items">
                <div className="portfolio__items--thumbnail position__relative">
                  <Link
                    className="portfolio__items--thumbnail__link glightbox"
                    href="assets/img/other/portfolio6.webp"
                    data-gallery="portfolio"
                  >
                    <img
                      className="portfolio__items--thumbnail__img"
                      src="assets/img/other/portfolio6.webp"
                      alt="portfolio-img"
                    />
                    <span className="portfolio__view--icon">
                      <svg
    ...
    <div className="container-fluid">
            ...
            <div className="footer__widget">
              ...
              <div className="footer__widget--inner">
                <Link className="footer__logo" href="index.html">
                  <img src="assets/img/logo/nav-log.webp" alt="footer-logo" />
                </Link>
            ...
            <div className="footer__widget">
              ...
              <ul className="footer__widget--menu footer__widget--inner">
                <li className="footer__widget--menu__list">
                  <Link className="footer__widget--menu__text" href="about.html">
                    About Us
                  </Link>
                </li>
                <li className="footer__widget--menu__list">
                ...
                <li className="footer__widget--menu__list">
                  <Link className="footer__widget--menu__text" href="contact.html">
                    Contact Us
                  </Link>
                </li>
                <li className="footer__widget--menu__list">
                ...
                <li className="footer__widget--menu__list">
                  <Link className="footer__widget--menu__text" href="faq.html">
                    Frequently
                  </Link>
                </li>
              </ul>
          ...
          <div className="col-lg-3 col-md-6">
            <div className="footer__widget">
              ...
              <ul className="footer__widget--menu footer__widget--inner">
                ...
                <li className="footer__widget--menu__list">
                  <Link className="footer__widget--menu__text" href="cart.html">
                    Shopping Cart
                  </Link>
                </li>
                <li className="footer__widget--menu__list">
                  <Link className="footer__widget--menu__text" href="login.html">
                    Login
                  </Link>
                </li>
                <li className="footer__widget--menu__list">
      ...
      <div className="footer__bottom d-flex justify-content-between align-items-center">
        <p className="copyright__content">
          Copyright © 2022{" "}
          <Link className="copyright__content--link" href="index.html">
            Furea
          </Link>{" "}
