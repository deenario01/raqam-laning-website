              ...
              <div className="col">
                <div className="breadcrumb__content">
                  ...
                  <ul className="breadcrumb__content--menu d-flex">
                    ...
                    <li className="breadcrumb__content--menu__items">
                      <span className="text-white">Blog Right Sidebar</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="row">
              <div className="col-xxl-9 col-xl-8 col-lg-8">
                <div className="blog__wrapper blog__wrapper--sidebar">
                  <div className="row row-cols-xl-3 row-cols-lg-2 row-cols-md-2 row-cols-sm-2 row-cols-1 mb--n30">
                        ...
                        <div className="blog__content">
                          ...
                          <h3 className="blog__content--title h4">
                            <Link href="/news-details">
                              Top 10 Best Furniture Company History you Should
                              Know
                            </Link>
                          </h3>
                      ...
                      <div className="blog__items">
                        <div className="blog__thumbnail">
                          ...
                          >
                            <img
                              className="blog__thumbnail--img display-block"
                              src="assets/img/blog/blog7.webp"
                              alt="blog-img"
                            />
                          </Link>
                        </div>
                      ...
                      <div className="blog__items">
                        <div className="blog__thumbnail">
                          ...
                          >
                            <img
                              className="blog__thumbnail--img display-block"
                              src="assets/img/blog/blog8.webp"
                              alt="blog-img"
                            />
                          </Link>
                        </div>
                      ...
                      <div className="blog__items">
                        <div className="blog__thumbnail">
                          ...
                          >
                            <img
                              className="blog__thumbnail--img display-block"
                              src="assets/img/blog/blog9.webp"
                              alt="blog-img"
                            />
                          </Link>
                        </div>
                      ...
                      <div className="blog__items">
                        <div className="blog__thumbnail">
                          ...
                          >
                            <img
                              className="blog__thumbnail--img display-block"
                              src="assets/img/blog/blog10.webp"
                              alt="blog-img"
                            />
                          </Link>
                        </div>
                  ...
                  <div className="pagination__area bg__gray--color">
                    <nav className="pagination justify-content-center">
                      <ul className="pagination__wrapper d-flex align-items-center justify-content-center">
                        ...
                        <li className="pagination__list">
                          <Link href="/news" className="pagination__item link">
                            2
                          </Link>
                        </li>
                        <li className="pagination__list">
