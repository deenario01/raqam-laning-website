            ...
            <div className="row row-cols-1">
              <div className="col">
                <div className="section__heading text-center mb-40">
                  <h2 className="compare__heading--maintitle">
                    ...
                    <thead className="compare__table--header">
                      <tr className="compare__table--items">
                        <td className="compare__table--items__child">
                          ...
                          <h4 className="compare__product--title">
                            Cotton Dress
                          </h4>
                          <img
                            className="compare__product--thumbnail"
                            src="assets/img/product/product1.webp"
                            alt="compare-image"
                          />
                        </td>
                      ...
                      <tr className="compare__table--items">
                        <td className="compare__table--items__child">
                          <p className="compare__description">
                            ...
                            fugiat vitae the are commodi nihil.
                          </p>
                        </td>
                        <td className="compare__table--items__child">
                          <p className="compare__description">
