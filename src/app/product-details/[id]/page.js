  ...
  return (
    ...
    <main className="main__content_wrapper">
      ...
      <section className="product__details--section section--padding">
        <div className="container">
          {/* Product Heading - Always Visible */}
          <div className="row">
            <div className="col-12">
              <div className="product__details--heading mb-4">
                <h1 className="product__details--heading__title">
                  {product.name}
                </h1>
                <p className="product__details--heading__desc">
                  {product.description}
                </p>
              </div>
            </div>
                ...
                <div className="product__media--preview">
                  <div className="product__media--preview__items">
                    <Link
                      ...
                      href={product.primaryImage}
                    >
                      <img
                        className="product__media--preview__items--img product__media--mobile"
            ...
            <div className="col-12 col-md-6">
              <div className="product__details--info">
                <form action="#">
                  ...
                  <div className="product__details--desktop-header d-none d-md-block">
                  ...
                  {product.features && product.features.length > 0 && (
                    <div className="product__features mb-20">
                      <h3 className="product__features--title mb-15">Features:</h3>
                      <ul className="product__features--list">
                        {product.features.map((feature, index) => (
                          <li key={index} className="product__features--item mb-8">
                            <span className="product__features--icon me-2">•</span>
                            {feature}
                          </li>
                        ))}
                      </ul>
                  ...
                  {product.applications && product.applications.length > 0 && (
                    <div className="product__applications mb-20">
                      <h3 className="product__applications--title mb-15">Applications:</h3>
                      <p className="product__applications--text">
    ...
    <PopularProducts skip={product.id} />
