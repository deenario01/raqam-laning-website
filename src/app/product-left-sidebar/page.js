              ...
              <div className="col">
                <div className="breadcrumb__content">
                  ...
                  <ul className="breadcrumb__content--menu d-flex">
                    ...
                    <li className="breadcrumb__content--menu__items">
                      <span className="text-white">Product Sidebar</span>
                    </li>
                  </ul>
                </div>
              </div>
                        ...
                        <div className="product__details--info">
                          <form action="#">
                            ...
                            <p className="product__details--info__desc mb-20">
                              ...
                              elit. Aut numquam ullam is recusandae laborum
                              explicabo id sequi quisquam, ab sunt deleniti
                              quidem ea animi facilis quod nostrum odit!
                              Repellendus voluptas suscipit cum harum dolor
                              sciunt.
                            </p>
                      ...
                      <div className="tab_content">
                        <div id="description" className="tab_pane active show">
                          <div className="product__tab--content">
                            <div className="product__tab--content__items style2 mb-40 d-flex align-items-center">
                              <div className="product__tab--content__thumbnail style2">
                                <img
                              ...
                              <div className="product__tab--content__right style2">
                                <div className="product__tab--content__step mb-20">
                                  ...
                                  <p className="product__tab--content__desc">
                                    ...
                                    quibusdam, magnam a vitae corporis! Magnam
                                    enim modi, illo harum suscipit tempore aut
                                    dolore doloribus deserunt voluptatum illum,
                                  </p>
                                </div>
                            ...
                            <div className="product__tab--content__items style2 d-flex align-items-center">
                              <div className="product__tab--content__thumbnail style2">
                                <img
                                  className="product__tab--content__thumbnail--img display-block"
                                  src="assets/img/product/product2.webp"
                            ...
                            <div className="product__tab--content">
                              <div className="product__tab--content__step mb-30">
                                ...
                                <p className="product__tab--content__desc">
                                  ...
                                  enim modi, illo harum suscipit tempore aut
                                  dolore doloribus deserunt voluptatum illum,
                                  est porro? Ducimus dolore accusamus impedit
                                  ipsum maiores, ea iusto temporibus numquam
                                  eaque mollitia fugiat laborum dolor tempora
                                  eligendi voluptatem quis necessitatibus nam
                                  ab?
                                </p>
                              </div>
                              <div className="product__tab--content__step">
                                ...
                                <ul>
                                  ...
                                  <li className="product__tab--content__list">
                                    ...
                                    Repellendus itaque sit quia consequuntur,
                                    unde veritatis. dolorum?
                                  </li>
                                </ul>
                              </div>
                            </div>
