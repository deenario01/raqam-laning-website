...
export default function BlogSocialShare({ title, url }) {
  // Generate share URLs for different platforms
  const shareUrls = {
    facebook: `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(url)}`,
    twitter: `https://twitter.com/intent/tweet?text=${encodeURIComponent(title)}&url=${encodeURIComponent(url)}`,
    instagram: `https://www.instagram.com/RAQAMinternationalco`,
      ...
      <ul className="d-flex">
        ...
        <li className="blog__social--media__list">
          ...
          >
            ...
            <span className="visually-hidden">Share on X (Twitter)</span>
          </Link>
        </li>
        <li className="blog__social--media__list">
          <Link
          ...
          >
            ...
            <span className="visually-hidden">Follow on Instagram</span>
          </Link>
        </li>
        <li className="blog__social--media__list">
          <Link
